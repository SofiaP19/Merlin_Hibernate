 ...
 */
@Entity
@Table(name = "model_reaction", catalog = "merlin_basic2")
public class ModelReaction implements java.io.Serializable {
	...
	public ModelReaction(String name, String equation, Boolean reversible, String booleanRule, Boolean inModel,
			Boolean isGeneric, Boolean isSpontaneous, Boolean isNonEnzymatic, String source, boolean originalReaction,
			Integer compartmentIdcompartment, String notes, Long lowerBound, Long upperBound) {
		this.name = name;
