 ...
 */
@Entity
@Table(name = "transporters_identification_projects", catalog = "merlin_basic2")
public class TransportersIdentificationProjects implements java.io.Serializable {
	...
	public TransportersIdentificationProjects(int organismId, boolean latestVersion, Date date, String organismName,
			String organismLineage, String compartmentsTool) {
		this.organismId = organismId;
		this.latestVersion = latestVersion;
		this.date = date;
